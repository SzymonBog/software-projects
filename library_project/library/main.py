...
class DatabaseConnection:  # singleton
    ...
    def __init__(self, database_name):
        ...
        if self.cursor.execute("select name from sqlite_master where type='table'").fetchall() == []:
            ...
            self.mydb.commit()
            print(f"[green]Database {self.database_name} created[/green]")  # :boom:")
        else:
            # for testing
            ...
            print("[green]Server has been successfully connected[/green]")
            pass
                    ...
                    if choice3 == "1":
                        ...
                        while year_change:
                            try:
                                ...
                                print("[red]Year has to be an integer[/red]")
                        ...
                        while copies_change:
                            try:
                                ...
                                print("[red]Copies has to be an integer[/red]")
...
def list_owned_books(user: User, iterator: BookIterator):
    loop1 = True
    while loop1:
        iterator.find_owned_books(user)
        ...
        match(choice):
            ...
            case "2":
                ...
                if genre != []:
                    ...
                    while loop1:
                        ...
                        try:
                            ...
                            if not 0 <= choice2 <= len(genre):
                                raise ValueError("[red]Invalid choice[/red]")
                            else:
                                if choice2 == 0:
                                    loop1 = False
                                else:
                    ...
                    print("[yellow]There are no books[/yellow]")
            ...
            case "6":
                list_owned_books(user, iterator)
                return user
